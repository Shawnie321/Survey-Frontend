...
export default function AdminDashboard() {
 ...
 className="text-red-600 text-sm hover:underline px-2 py-1 rounded hover:bg-red-50"
 >
 Delete
 </button>
 </li>
 ...
 <svg width="48" height="48" fill="none" viewBox="002424" stroke="currentColor" className="mb-2"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M917v-2a44000-4-4H5a44000-44v2m16-2a44000-4-4h-1a44000-44v2m6-2a44000-4-4h-1a44000-44v2" /></svg>
